...
const formSchema = z.object({
  ...
  name: z.string().trim().min(2, { message: "Please enter your full name" }).max(100).regex(/^[\p{L}\s\-']+$/u, { message: "Name can only contain letters, spaces, hyphens, and apostrophes" }),
